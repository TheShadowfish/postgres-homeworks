...
SELECT * FROM orders  WHERE ship_city LIKE '%burg';
...
-- SELECT SUM(freight) AS sum_more_2750 FROM orders WHILE ship_region IS NOT NULL GROUP BY ship_country HAVING SUM(freight) > 2750;
